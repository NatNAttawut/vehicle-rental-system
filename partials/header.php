  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="mainNav">
      <ul class="navbar-nav mx-auto gap-lg-3">
        <li class="nav-item">
          <a class="nav-link <?= ($_SERVER['REQUEST_URI']=='/' || str_contains($_SERVER['REQUEST_URI'],'index.php'))?'active':'' ?>" href="/index.php">หน้าแรก</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'],'cars.php')?'active':'' ?>" href="/cars.php">รถยนต์</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'],'motorcycle.php')?'active':'' ?>" href="/motorcycle.php">มอเตอร์ไซค์</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'],'guide.php')?'active':'' ?>" href="/guide.php">คู่มือ</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'],'contact.php')?'active':'' ?>" href="/contact.php">ติดต่อ</a>
        </li>
      </ul>
    </div>
  </div>
